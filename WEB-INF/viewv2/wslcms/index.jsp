...
<body>
    ...
    <script src="${wslconfig.static_path}bower_components/raphael/raphael-min.js"></script>
    <script src="${wslconfig.static_path}bower_components/morrisjs/morris.min.js"></script>
    <script src="${wslconfig.static_path}js/morris-data.js"></script>
