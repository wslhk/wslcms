		  ...
		  <div class="int_info">
			  <!--case1 选择平台-->
				...
				<div style="" class="create_ad_target content_table">
				  <h3 class="m_subtit account_title">单页编辑</h3>
...
<input type="hidden" name="id" value="${page.id}" />
  ...
  <td><input type="hidden" name="picture" value="${page.picture}" />
<input  name="file_picture" type="file" value="" /><span></span>
</td></tr>
                  
					</tbody></table>
                    <input type="submit" class="btn nextone saveBtn" value="保存"/>
                     <a  class="btn nextone saveBtn" value="保存" href="page.action?chapterId=${page.chapterId}">返回</a>
                  </form>
