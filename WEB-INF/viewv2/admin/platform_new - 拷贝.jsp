...
<title>平台增加 - 漫画数字单行本综合管理平台（CCAPS）</title><jsp:include page="include/include_head.jsp"></jsp:include>
</head>
...
<td><input type="text" name="name" /><span></span>
</td></tr>
...
<td><input  name="file_icon" type="file" value="" /><span></span>
</td></tr>
