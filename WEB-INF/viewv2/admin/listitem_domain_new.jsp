...
<h3>当前列表</h3>
<form action="listitem_domain_new.action">
...
<c:forEach items="${domains}" var="domain">
            <tr class="odd">
              <td class="tac sorting_1"><input type="checkbox" name="domainIds" value="${domain.id}"/></td>
              <td class="tac sorting_1">${domain.name}</td>
              <td class="tac sorting_1"><img src="../uploadimg/domain/${domain.logo}" width="100"/></td>
              <td class="tac">&nbsp;</td></tr>
            </c:forEach>
