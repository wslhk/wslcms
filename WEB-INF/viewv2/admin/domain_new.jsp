		  ...
		  <div class="int_info">
			  <!--case1 选择平台-->
				...
				<div style="" class="create_ad_target content_table">
				  <h3 class="m_subtit account_title">内容商</h3>
                  <form id="form_domain" action="domain_do.action" method="post" enctype="multipart/form-data">
...
<td><input  name="file_logo" type="file" value="" class="ipt ipt_text" /><span></span>
</td></tr>
