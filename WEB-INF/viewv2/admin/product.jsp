...
<div id="content">
    <div class="main">
        ...
        <li id="shows" class="" onclick="Filter.add('language',${language.id})">${language.name}</li>
            ...
            <form method="get" action="product.action">
...
<c:forEach items="${products}" var="product">
            <tr class="odd">
              ...
              <td class="tac sorting_1">${product.name}</td><td class="tal">
...
${product.pageCount}
              ...
              <td class="tac">
                ...
                <a href="product_edit.action?id=${product.id}">编辑&amp;内支付</a>
                |
                <span class='edit'> </span>
                
                <span class='delete'><a class='submitdelete' onclick='return showNotice.warn();' href='product_do.action?action=delete&id=${product.id}'>删除</a>  </span>
              </td></tr>
            </c:forEach>
            
            </tbody></table>
            <jsp:include page="include/page.jsp"></jsp:include>
       <!-- <a href="product_new.action?language=${param.language}"  class="btn nextone saveBtn">添加</a> -->    
