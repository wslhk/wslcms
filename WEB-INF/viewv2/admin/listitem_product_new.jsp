...
<h3>当前列表</h3>
<form action="listitem_product_new.action">
...
<input type="hidden" name="action" value="add"/>
            <table cellspacing="0" cellpadding="0" border="0" class="datatable totaltable" width="100%" ><thead><tr>
			  ...
			  <th class="sorting_disabled tac" rowspan="1" >漫画封面</th>
			            <th class="sorting_disabled tac" rowspan="1" colspan="1" >商品</th>
			            <th class="sorting_disabled tac" rowspan="1" >商品图</th>
...
<c:forEach items="${products}" var="product">
            <tr class="odd">
              <td class="tac sorting_1"><input type="checkbox" name="productIds" value="${product.id}"/></td>
              <td class="tac sorting_1">${product.comic.name}</td>
              <td class="tac sorting_1"><img src="../uploadimg/comic/${product.comic.cover}" width="100"/></td>
              <td class="tac sorting_1">${product.name}</td>
              <td class="tac"><img src="../uploadimg/comic/${product.cover}"  width="100"/></td>
              <td class="tac">&nbsp;</td></tr>
            </c:forEach>
