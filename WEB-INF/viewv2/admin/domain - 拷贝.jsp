...
<h2>内容商
<a href="domain_new.action" class="button add-new-h2">添加</a>
...
<table class="wp-list-table widefat fixed users" cellspacing="0">
	...
	<tr>
		...
		<th scope='col'  class='manage-column column-role'  style="">logo</th>
...
<c:forEach items="${listdomain}" var="domain">
	...
	<td class="username column-username"><strong><a href="ad_edit.action?id=${ad.id}&type=${ad.type}">${domain.name}</a></strong><br /><div class="row-actions">
    
    <span class='edit'>
   
    <a href="domain_edit.action?id=${domain.id}">编辑</a>
    | 
    </span>
    <span class='delete'><a class='submitdelete' onclick='return showNotice.warn();' href='domain_do.action?action=delete&id=${domain.id}'>永久删除</a>  </span>
    </div></td>
