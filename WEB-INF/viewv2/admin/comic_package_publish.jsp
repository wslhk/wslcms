...
<div id="wpwrap">
<div id="wpcontent">
<jsp:include page="include/wphead.jsp"><jsp:param name="nav" value="0"></jsp:param></jsp:include>
...
<div class='media-item'>
 ...
 <input type='radio'  name='platformId' value='${platform.id}'  /> ${platform.name}
            ...
            <tr>
		    <th valign='top' scope='row' class='label'><label><span class="field">pro文件</span><br class='clear' /></label></th>
		    
		    <td class='field'><input name="file_pro" type="file" value=""  /><span></span></td>
		    </tr>
            <tr >
