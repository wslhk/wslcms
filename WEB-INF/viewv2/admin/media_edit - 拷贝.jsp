...
<td><input type="text" name="title" value="${media.title}" /><span></span>
</td></tr>

<tr><th><label>文件：</label></th>
  <td><input  name="file_media" type="file" value="" /> 
  <input type="hidden" name="fileName" value="${media.fileName}" /><span></span>
</td></tr>

<tr><th><label for="role">文件播放长度(秒)：</label></th>
<td><input type="text" name="second" value="${media.second}" />秒<span></span>
</td></tr>
