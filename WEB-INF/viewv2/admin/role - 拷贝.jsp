...
<h2>
权限	<a href="role_new.action" class="button add-new-h2">增加新权限</a>
</h2>
...
<table class="wp-list-table widefat fixed users" cellspacing="0">
	...
	<tr>
		...
		<th scope='col'  class='manage-column column-username sortable desc'  style="">标题</th><th scope='col'  class='manage-column column-email sortable desc'  style="">key</th><th scope='col'  class='manage-column column-role'  style="">描述</th><th scope='col'  class='manage-column column-posts num'  style="">&nbsp;</th>	</tr>
	</tfoot>
...
<c:forEach items="${listManagerRole}" var="role">
  <tr class="alternate">
    ...
    <td class="username column-username">${role.id}
      ...
      <div class="row-actions"><span class='edit'><a href="role_edit.action?id=${role.id}">编辑</a></span> 
