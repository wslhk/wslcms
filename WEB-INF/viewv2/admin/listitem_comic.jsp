...
<c:forEach items="${listlink}" var="link">
            <tr class="odd">
              ...
              <td class="tac sorting_1">${link.comic.name}</td>
              <td class="tac"><img width="100" src="../uploadimg/comic/${link.comic.cover}"/></td>
        ...
        <a href="listitem_comic_new.action?id=${listitem.id}"  class="btn nextone saveBtn">添加</a>     
