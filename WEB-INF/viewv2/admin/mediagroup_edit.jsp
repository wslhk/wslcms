		  ...
		  <div class="int_info">
			  <!--case1 选择平台-->
				...
				<div style="" class="create_ad_target content_table">
				  <h3 class="m_subtit account_title">媒体组编辑</h3>
                  <form id="form_ad" action="mediagroup_do.action" method="post">
<input type="hidden" name="action" value="edit" />
<input type="hidden" name="id" value="${mediagroup.id}" />
  <p>&nbsp;</p>

<h3>修改</h3>
<table class="form-table">
<tr><th><label for="role">标题：</label></th>
<td><input type="text" name="title" value="${mediagroup.title}" class="ipt ipt_text" /><span></span>
</td></tr>
</table>
