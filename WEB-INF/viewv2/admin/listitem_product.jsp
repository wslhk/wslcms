...
<c:forEach items="${listlink}" var="link">
            <tr class="odd">
              ...
              <td class="tac sorting_1">${link.product.name}</td>
              <td class="tac"><img width="100" src="../uploadimg/comic/${link.product.cover}"/></td>
        ...
        <a href="listitem_product_new.action?id=${listitem.id}"  class="btn nextone saveBtn">添加</a>     
