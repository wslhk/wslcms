...
public class CmsProcessLogoutDo extends CmsProcessBase implements CmsProcess{
	...
	public void process(HttpServletRequest request,
		...
		if(this.authLogout(request, username, password)){
	...
	private boolean authLogout(HttpServletRequest request,String username,String password){
